...
> The $Q$-test was nont significant, $Q$(`r meta$df.Q`) = `r round(meta$Q, 2)`, $p$ = `r format.pval(meta$pval.Q, digits = 3, scientific = FALSE)`. Thus, we fail to reject the null hypothesis that the observed variation in effect sizes can be attributed to sampling error alone.
...
# Perform PET test
PET <- metafor::rma(yi = smd, sei = se, mods = ~se, 
                    data = dat, method = "FE")
